...
class WeightViewModel(
    ...
    val initialWeightKgState = flowOf(WeightState::initialWeightKg).collectStateUI(0f)
    val currentWeightKgState = flowOf(WeightState::currentWeightKg).collectStateUI(0f)
    val selectedTabState = flowOf(WeightState::selectedTab).collectStateUI(WeightReportTab.MONTH)
    val periodTitleState = flowOf(WeightState::periodTitle).collectStateUI("")
    val showAddWeightSheetState = flowOf(WeightState::showAddWeightSheet).collectStateUI(false)
    val draftWeightKgState = flowOf(WeightState::draftWeightKg).collectStateUI(0f)
    val chartDataState = flowOf(WeightState::chartData).collectStateUI(emptyList())
    val xAxisLabelsState = flowOf(WeightState::xAxisLabels).collectStateUI(emptyList())
    val yMinState = flowOf(WeightState::yMin).collectStateUI(0f)
    val yMaxState = flowOf(WeightState::yMax).collectStateUI(1f)
